  ...
  render() {
    return (
      <Container>
        ...
        <p>My skills include a strong knowledge of HTML 5, CSS3, Javascript and jQuery. A thorough understanding of CSS frameworks, Git, Node.js and Express.js. I have large amounts of exposure to MySQL and MongoDB, and a little bit too much persistence. “If it were easy, everyone would do it.”
        </p>
