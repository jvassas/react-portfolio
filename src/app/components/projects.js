      ...
      <div className="projects">
        ...
        <CardDeck>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Title><h3>VTC</h3></Card.Title>
              <Card.Text>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Title><h3>Get On Brand</h3></Card.Title>
              <Card.Text>
        ...
        <CardDeck>
          <Card>
            ...
            <Card.Body>
              <Card.Title><h3>React Click Game</h3></Card.Title>
              <Card.Text>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Title><h3>CookBook</h3></Card.Title>
              <Card.Text>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Title><h3>Eat A Burger</h3></Card.Title>
              <Card.Text>
        ...
        <CardDeck>
          <Card>
            ...
            <Card.Body>
              <Card.Title><h3>Bamazon</h3></Card.Title>
              <Card.Text>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Title><h3>LIRI Bot</h3></Card.Title>
              <Card.Text>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Title><h3>City Guide</h3></Card.Title>
              <Card.Text>
        ...
        <CardDeck>
          <Card>
            ...
            <Card.Body>
              <Card.Title><h3>Gif Generator</h3></Card.Title>
              <Card.Text>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Title><h3>Train Schedule</h3></Card.Title>
              <Card.Text>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Title><h3>NBA Trivia</h3></Card.Title>
              <Card.Text>
        ...
        <CardDeck>
          <Card>
            ...
            <Card.Body>
              <Card.Title><h3>Crytsal Collector</h3></Card.Title>
              <Card.Text>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Title><h3>Sports Hangman</h3></Card.Title>
              <Card.Text>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Title><h3>Basic Portfolio</h3></Card.Title>
              <Card.Text>
